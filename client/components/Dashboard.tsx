        ...
        <div className="p-6">
          ...
          <nav className="space-y-2">
            {sidebarItems.map((item) => (
              ...
              >
                <item.icon
                  className={`w-5 h-5 ${item.active ? "text-valorant-red" : "group-hover:text-valorant-cyan"}`}
                />
                <span className="font-medium">{item.label}</span>
                {item.badge && (
                  <Badge className="ml-auto bg-valorant-gold text-black text-xs">
                    {item.badge}
                  </Badge>
                )}
              </button>
          ...
          <Card className="mt-8 bg-gradient-to-r from-valorant-purple/20 to-valorant-cyan/20 border-valorant-cyan/30">
            <CardHeader className="pb-2">
              <CardTitle className="text-sm text-valorant-gold">
                Quick Stats
              </CardTitle>
            </CardHeader>
            <CardContent className="space-y-2 text-xs">
              ...
              <div className="flex justify-between">
                ...
                <span className="text-valorant-cyan font-bold">
                  {stats.featuredCount}
                </span>
              </div>
            </CardContent>
